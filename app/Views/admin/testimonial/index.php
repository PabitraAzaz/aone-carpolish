...
<div class="content">
    ...
    <div class="container mb-5">
        <a href="<?= base_url('admin/testimonial/create-testimonial') ?>"
            class="btn btn-sm btn-success">
            <i class="bi bi-plus"></i> নতুন টেস্টিমোনিয়াল যোগ করুন
        </a>

    </div>
    <div class="container-fluid">
        <h3 class="mb-4">⭐ টেস্টিমোনিয়াল লিস্ট</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($t['image'])): ?>
                                        <img src="<?= base_url('uploads/testimonials/' . $t['image']); ?>"
